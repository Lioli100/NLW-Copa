...
import userAvatarExampleImg from "../assets/users-avatar-exemples.png"
import iconCheckImg from "../assets/icon-check.svg"
import { api } from "../lib/server"
import { FormEvent, useState } from "react"
import { getServerSideProps } from "../lib/load.data"
...
export async function getStaticProps() {
  const boloes = await getServerSideProps()

  return {
     props: {
       poolCount: boloes.data.count,
       guessCount: boloes.dataguesse.count,   
       userCount: boloes.datauser.count
      }
     }
}
